@extends('layouts.main', ['class' => 'off-canvas-sidebar', 'activePage' => 'register', 'title' => __('ChekP')])
            ...
            <form class="form" method="POST" action="{{ route('register') }}">
                ...
                <div class="card card-login card-hidden mb-3">
                    ...
                    <div class="card-body ">
                        ...
                        <div class="bmd-form-group{{ $errors->has('nombreUsuario') ? ' has-danger' : '' }}">
                            <div class="input-group">
                                ...
                                <input type="text" name="nombreUsuario" class="form-control" placeholder="{{ __('Name...') }}"
                                    value="{{ old('nombreUsuario') }}" required autocomplete="nombreUsuario" autofocus>
                            </div>
                            @if ($errors->has('nombreUsuario'))
                            <div id="name-error" class="error text-danger pl-3" for="nombreUsuario" style="display: block;">
